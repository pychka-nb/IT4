...
// IT4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT4App, CWinApp)
...
// Единственный объект CIT4App

CIT4App theApp;


// Инициализация CIT4App

BOOL CIT4App::InitInstance()
{
